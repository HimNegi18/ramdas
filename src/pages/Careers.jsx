...
//   return (
//     <section>
//       <Heading title="Carrers" path="/carrers" />
//       <section>
...
//                   className="input border-gray-300 w-full border px-6 py-2"
//                 />
//                 <FaFile className="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-400" />
//               </div>
...
//           <div
//             className="w-[400px] bg-[#991b1b] rounded-xl
//                        lg:pt-2 lg:pr-2
